    ...
    <div class="panel-body form-horizontal">
        <form method="post" data-parsley-validate="" novalidate=""
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label class="col-sm-3 control-label"><?= lang('location') ?> <span class="required"> *</span></label>
                <div class="col-sm-8">
                    <div class="input-group">
                        <span class="input-group-addon" id=""><i class="fa fa-map-marker"></i></span>
                        <input required type="text" data-parsley-type="text" name="location" class="form-control"
                               placeholder="<?= lang('enter') . ' ' . lang('location') ?> ">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label"><?= lang('Background Information') ?> </label>
                <div class="col-sm-9">
                    <textarea name="cover_letter" class="form-control textarea_2" rows="5"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label"><?= lang('Upload Documents') ?> <span class="required"> *</span></label>
                <div class="col-sm-9">

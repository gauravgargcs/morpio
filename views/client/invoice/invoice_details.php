        ...
        <div class="row mb-lg">
            ...
            <div class="col-lg-4 col-xs-12 pv">
                ...
                <div class="clearfix">
                    ...
                    <p class="pull-right mr"><?= display_datetime($invoice_info->invoice_date); ?></p>
                </div>
                <div class="clearfix">
                    <p class="pull-left"><?= $language_info['due_date'] ?></p>
                    <p class="pull-right mr"><?= display_datetime($invoice_info->due_date); ?></p>
                </div>
            ...
            <table class="table">
                ...
                foreach ($all_payment_info as $v_payments_info) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url() ?>client/invoice/manage_invoice/payments_details/<?= $v_payments_info->payments_id ?>"><?= display_datetime($v_payments_info->payment_date); ?></a>
                        </td>

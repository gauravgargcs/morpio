...
<!-- Modal -->
<div class="modal fade" id="myModal_extra_lg" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    $('#myModal_extra_lg').on('shown.bs.modal', function (e) {
        ...
        modalBody.load(recipient, function() { 
          ...
          $(".modal_select_box").select2({
            dropdownParent: $("#myModal_extra_lg")
          });

        ...
        <td style="background-color: rgba(84, 73, 73, 0.12);">
            ...
            <ul class="list">
                ...
                <li class="list"><?= lang('client') ?><span
                        class="xright"><?= $quotations_info->name; ?></span>
                </li>
                ...
                <li class="list"><?= lang('date') ?><span
                        class="xright"><?= display_datetime($quotations_info->quotations_date) ?></span>
                </li>
                ...
                <?php if (!empty($reviewer_info)): ?>
                    ...
                    <li class="list"><?= lang('reviewed_date') ?><span
                            class="xright"><?= display_datetime($quotations_info->reviewed_date) ?></span>
                    </li>
                <?php endif; ?>

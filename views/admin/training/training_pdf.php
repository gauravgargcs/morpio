            ...
            <tr>
                ...
                <td>
                    <table style="width: 500px; margin-left: 10px; margin-bottom: 10px; font-size: 13px;">
                        ...
                        <?php super_admin_pdf($training_info->companies_id, null, true) ?>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 70%"><?= display_datetime($training_info->joining_date) ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
...
<div style="width: 100%;">
    ...
    <table style="width: 100%; font-size: 13px;margin-top: 20px">
        ...
        <tr>
            ...
            <td style="">&nbsp; <?php
                echo display_datetime($training_info->start_date);
                ?></td>
        </tr>
        <tr>
            ...
            <td style="">&nbsp; <?php
                echo display_datetime($training_info->finish_date);
                ?></td>
        </tr>
        <tr>

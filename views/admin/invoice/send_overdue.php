                            ...
                            <ul class="nav flex-column" role="tablist" aria-orientation="vertical">            
                                ...
                                if (!empty($all_invoices_info)) {
                                    foreach ($all_invoices_info as $v_invoices) {
                                        ...
                                        ?>
                                <li class="nav-item">
                                    <a class="nav-link <?php if ($v_invoices->invoices_id == $this->uri->segment(5)) { echo "active"; } ?>" href="<?= base_url() ?>admin/invoice/manage_invoice/send_overdue/<?= $v_invoices->invoices_id ?>">
                                        <?= $client_name ?>

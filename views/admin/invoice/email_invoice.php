    ...
    <div class="col-lg-12">
        <div class="row mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="pull-right float-end">
                            <a style="margin-top: -5px" href="<?= base_url() ?>admin/invoice/manage_invoice/create_invoice" data-original-title="<?= lang('new_invoice') ?>" data-bs-toggle="tooltip" data-bs-placement="top"  class="btn btn-icon btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
                        </div>
                            ...
                            <ul class="nav flex-column" role="tablist" aria-orientation="vertical">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php
                                        if ($v_invoices->invoices_id == $this->uri->segment(5)) { echo "active"; } ?>" href="<?= base_url() ?>admin/invoice/manage_invoice/email_invoice/<?= $v_invoices->invoices_id ?>">
                                        <?= $client_name ?>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4"><?= lang('email_invoice') ?></h4>
                        ...
                        <form class="form-horizontal" method="post" action="<?= base_url() ?>admin/invoice/send_invoice_email/<?= $invoice_info->invoices_id ?>">
                            ...
                            ?>
                            <input type="hidden" name="client_name" value="<?= ucfirst($clientName) ?>">
                            <input type="hidden" name="currency" value="<?= $invoice_info->currency; ?>">

                            <input type="hidden" name="amount" value="<?= ($this->invoice_model->calculate_to('invoice_due', $invoice_info->invoices_id)) ?>">

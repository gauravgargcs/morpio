...
<div class="row">
    <div class="col-xl-5">
        <div class="card border">
            <div class="card-body">
                <h4 class="card-title mb-4"><?= lang('edit_payment') ?></h4>
                        ...
                        <div class="input-group">
                            <input type="text" required="" name="payment_date" class="form-control datepicker"
                                   ...
                                   if (!empty($payments_info->payment_date)) {
                                       echo date('d-m-Y H-i', strtotime($payments_info->payment_date));
                                   } else {
                                       echo date('d-m-Y H-i');
                                   }
    ...
    <div class="col-xl-7">
        <div class="card border">
            <div class="card-body">
                ...
                <h4 class="card-title mb-3"> <?= lang('payment_details') . '- ' . $payments_info->trans_id ?></h4>

<form id="form_validation" action="<?php echo base_url() ?>admin/projects/update_member/<?php if (!empty($project_info->project_id)) echo $project_info->project_id; ?>" method="post" class="form-horizontal">
    ...
    <div class="modal-body wrap-modal wrap">
       <div class="row mb-3">
            <div class="col-xl-12"> 
                <div class="row">      
                    ...
                    <div class="form-check mb-3 col-xl-3">
                        <input id="everyone" <?php if (!empty($project_info->permission) && $project_info->permission == 'all') {
                                echo 'checked';
                            }
            ...
            <div class="row mb-3">
                <div class="col-xl-11"> 
                    <div class="row <?php if (!empty($project_info->permission) && $project_info->permission != 'all') { echo 'show'; } ?>" id="permission_user">
                        ...
                        if (!empty($assign_user)) { ?>
                            ...
                            <div class="action p  <?php   if (!empty($project_info->permission) && $project_info->permission != 'all') { $get_permission = json_decode($project_info->permission);
                                if (is_object($get_permission)) {
                                    foreach ($get_permission as $user_id => $v_permission) {
                                        if ($user_id == $v_user->user_id) {
                                            echo 'show';

<form action="<?= base_url() ?>admin/projects/save_attachment" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" accept-charset="utf-8" novalidate="novalidate">
    ...
    <div class="modal-footer">
        <div class="mb-3">
            ...
            <button id="file-save-btn" type="submit" disabled="disabled" class="btn btn-primary start-upload"><span class="fa fa-check-circle"></span> <?php echo lang('save'); ?></button>            
        </div>
    </div>
</form>       
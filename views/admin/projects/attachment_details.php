...
<div class="modal-header">
    ...
    <a data-bs-toggle="tooltip" data-bs-placement="top" title="<?= lang('download') . ' ' . lang('all') ?>" style="position: absolute;right: 50px" href="<?= base_url() ?>admin/projects/download_all_files/<?= $attachment_info->task_attachment_id ?>" class="pull-right"><i class="fa fa-1x fa-cloud-download"></i></a>
</div>
                                ...
                                if (!empty($v_files)) {
                                    ...
                                    <?php } else { ?>
                                        <div class="no-preview">
                                            <span><p><?= lang('no_preview_available') ?></p><strong><a style="color: #fff" href="<?= base_url() ?>admin/projects/download_files/<?= $v_files->uploaded_files_id ?>"> <?= $v_files->file_name ?></a></strong></span>

                                            <a href="<?= base_url() ?>admin/projects/download_files/<?= $v_files->uploaded_files_id ?>" class="pull-right"><i  class="fa fa-2x fa-cloud-download"></i></a>
                                        </div>
                                    <?php } ?>
                                <?php } ?>
                                <hr/>

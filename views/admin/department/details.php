        ...
        <div class="card border">
            <div class="card-body">
                <div class="pull-right float-end">
                    <button type="submit" name="save" value="1" class="btn btn-primary btn-sm"><?php echo !empty($departments_info->deptname) ? lang('update') : lang('save') ?></button>

                    <button type="submit" name="save" value="2" class="btn btn-primary btn-sm"><?php echo !empty($departments_info->deptname) ? lang('update') . ' & ' . lang('add_more') : lang('save') . ' & ' . lang('add_more') ?></button>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="row mb-3">
                            <label class="col-lg-4 col-form-label"><?= lang('select') . ' ' . lang('department') ?>
                                <span
                        ...
                        <div class="row mb-3 new_departments"
                             style=" <?= (!empty($departments_info->departments_id) ? 'display:none' : '') ?>">
                            <label class="col-sm-4 col-form-label"><?= lang('new_department') ?></label>
                            <div class="col-sm-8">
                        ...
                        <div class="row mb-3">
                            <label class=" col-sm-4 col-form-label"><?= lang('designation') ?><span
                            ...
                            <tr>
                                <th>
                                    <div class="form-check form-check-primary mb-3 col-xl-6">
                                        <input id="select_all" type="checkbox" class="form-check-input">
                                        <label class="form-check-label" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= lang('select_all') . ' ' . lang('permission') ?>"><strong><?= lang('permission') ?></strong>
                                        </label>
                                    </div>
                                </th>
                                <th>
                                    <div class="form-check form-check-primary mb-3 col-xl-6">
                                        <input id="select_all_view" type="checkbox" class="form-check-input">
                                        <label class="form-check-label" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= lang('view_help') ?>">
                                ...
                                <th>
                                    <div class="form-check form-check-primary mb-3 col-xl-6">
                                        <input id="select_all_create" type="checkbox" class="form-check-input">
                                        <label class="form-check-label" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= lang('select_all') . ' ' . lang('create') ?>">
                                ...
                                <th>
                                    <div class="form-check form-check-primary mb-3 col-xl-6">
                                        <input id="select_all_edit" type="checkbox" class="form-check-input">
                                        <label class="form-check-label" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= lang('select_all') . ' ' . lang('edit') ?>">
                                ...
                                <th>
                                    <div class="form-check form-check-primary mb-3 col-xl-6">
                                        <input id="select_all_delete" type="checkbox" class="form-check-input">
                                        <label class="form-check-label" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= lang('select_all') . ' ' . lang('delete') ?>">
                            ...
                            if (!empty($menu_info)) {
                                foreach ($menu_info as $items) {
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        || $items->label == 'payroll_summary' || $items->label == 'generate_payslip' || $items->label == 'provident_fund' || $items->label == 'filemanager' || $items->label == 'leave_management' || $items->label == 'advance_salary' || $items->label == 'quotations_list'
                                                    ...
                                                    <tr style="background: #e2e2e2;">
                                                        <th>
                                                            <div id="parent_<?= $parent_id; ?>" class="parent plus pull-left">
                                                                <span>X</span></div>
                                                            <div class="form-check form-check-primary mb-3 col-xl-6 pull-left">
                                                                <input <?php
                                                                    ...
                                                                    ?> id="<?php if (!empty($parent_id)) {
                                                                        echo $parent_id;
                                                                    } ?>" type="checkbox" name="menu[]" value="<?= $parent_id; ?>" class="form-check-input">
                                                                <label class="form-check-label" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= lang('select_all') ?>">
                                                            ...
                                                            <div class="form-check form-check-primary mb-3 col-xl-6">
                                                                <input id="all_view_<?php if (!empty($parent_id)) {
                                                                        ...
                                                                        echo $parent_id;
                                                                           ...
                                                                           value="<?= $parent_id ?>" class="form-check-input">
                                                                <label class="form-check-label view" data-bs-toggle="tooltip"
                                                            ...
                                                            <div class="form-check form-check-primary mb-3 col-xl-6">
                                                                <input id="all_create_<?php if (!empty($parent_id)) {
                                                                        ...
                                                                        echo $parent_id;
                                                                           ...
                                                                           value="<?= $parent_id ?>" class="form-check-input">
                                                                <label class="form-check-label create" data-bs-toggle="tooltip"
                                                                       data-bs-placement="top"
                                                                       title="<?= lang('select_all') ?>">
                                                            ...
                                                            <div class="form-check form-check-primary mb-3">
                                                                <input id="all_edit_<?php if (!empty($parent_id)) {
                                                                        ...
                                                                        echo $parent_id;
                                                                           ...
                                                                           value="<?= $parent_id ?>" class="form-check-input">
                                                                <label class="form-check-label edit" data-bs-toggle="tooltip"
                                                                       data-bs-placement="top"
                                                                       title="<?= lang('select_all') ?>">
                                                            ...
                                                            <div class="form-check form-check-primary mb-3">
                                                                <input id="all_delete_<?php if (!empty($parent_id)) {
                                                                        ...
                                                                        echo $parent_id;
                                                                           ...
                                                                           value="<?= $parent_id ?>" class="form-check-input">
                                                                <label class="form-check-label delete" data-bs-toggle="tooltip"
                                                                       data-bs-placement="top"
                                                                       title="<?= lang('select_all') ?>">
                                                                        ...
                                                                        <td style="display: block;padding-left: 35px;">
                                                                            ...
                                                                            <div class="form-check form-check-primary mb-3 col-xl-6 pull-left">
                                                                                <input <?php
                                                                                    ...
                                                                                    ?> class="<?= $parent_id; ?> form-check-input"
                                                                                    ...
                                                                                    <td style="display: block;padding-left: 60px;">
                                                                                        ...
                                                                                        <div class="form-check form-check-primary mb-3 col-xl-6 pull-left">
                                                                                            <input
                                                                                                ...
                                                                                                ?>
                                                                                                class="<?= $parent_id . ' ' . $sub_chld; ?> form-check-input"
                                                                                                id="<?= $sub_chld_1; ?>"
                                                                                            ...
                                                                                            <tr style="background: #eeeeee">
                                                                                                <td style="display: block;padding-left: 85px;">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <span>X</span></div>
                                                                                                    <div
                                                                                                        class="form-check form-check-primary mb-3 col-xl-6 pull-left">
                                                                                                        <input
                                                                                                                <?php if (!empty($roll[$sub_chld_name_2])) {
                                                                                                                    echo $roll[$sub_chld_name_2] ? 'checked' : '';
                                                                                                                }
                                                                                                                ?>
                                                                                                                class="<?= $parent_id . ' ' . $sub_chld . ' ' . $sub_chld_1; ?> form-check-input"
                                                                                                                id="<?= $sub_chld_name_2; ?>"
                                                                                                                type="checkbox"
                                                                                                                name="menu[]"
                                                                                                        ...
                                                                                                        <td style="display: block;padding-left: 110px">
                                                                                                            <div  class="form-check form-check-primary mb-3">
                                                                                                                <input <?php if (!empty($roll[$v_sub_chld_4])) {
                                                                                                                    ...
                                                                                                                    ?> id="<?= $v_sub_chld_4; ?>"
                                                                                                                       class="<?= $parent_id . ' ' . $sub_chld . ' ' . $sub_chld_name_2 . ' ' . $sub_chld_1; ?> form-check-input"
                                                                                                                       type="checkbox"
                                                                                                                       name="menu[]"
                                                                                                                       value="<?= $v_sub_chld_4; ?>">
                                                                                                            <label class="form-check-label "
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <div class="form-check form-check-primary mb-3 col-xl-6">
                                                                                                                <input
                                                                                                                        ...
                                                                                                                        ?>
                                                                                                                        class="<?= $sub_chld . ' ' . $v_sub_chld_4 . ' ' . $sub_chld_name_2 . ' ' . $parent_id . ' ' . $sub_chld_1; ?> form-check-input"
                                                                                                                        type="checkbox"
                                                                                                                        name="view_<?= $v_sub_chld_4; ?>"
                                                                                                                        value="<?= $v_sub_chld_4; ?>">
                                                                                                            <label
                                                                                                                    class="form-check-label view"
                                                                                                                    data-bs-toggle="tooltip"
                                                                                                                    data-bs-placement="top"
                                                                                            ...
                                                                                            <td>
                                                                                                <div class="form-check form-check-primary mb-3 col-xl-6">
                                                                                                    <input <?php if (!empty($roll[$v_sub_chld_2])) {
                                                                                                        ...
                                                                                                        ?>
                                                                                                            class="<?= $sub_chld . ' ' . $parent_id . ' ' . $v_sub_chld_2 . ' ' . $sub_chld_1; ?> form-check-input"
                                                                                                            type="checkbox"
                                                                                            ...
                                                                                            <td>
                                                                                                <div class="form-check form-check-primary mb-3">
                                                                                                    <input <?php
                                                                                                        ...
                                                                                                        ?> class="<?= $sub_chld_1 . ' ' . $sub_chld . ' ' . $v_sub_chld_2 . ' ' . $parent_id; ?> form-check-input"
                                                                                                           type="checkbox"
                                                                                ...
                                                                                <td>
                                                                                    <div class="form-check form-check-primary mb-3 col-xl-6">
                                                                                        <input <?php
                                                                                            ...
                                                                                            ?> class="<?= $sub_chld . ' ' . $sub_chld_id . ' ' . $parent_id; ?> form-check-input"
                                                                                               type="checkbox"
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check form-check-primary mb-3 col-xl-6">
                                                                            <input <?php
                                                                                ...
                                                                                ?> class="<?= $parent_id . ' ' . $v_sub_child; ?> form-check-input"
                                                                                   type="checkbox"
                                                ...
                                                <td>
                                                    <div class="form-check form-check-primary mb-3 col-xl-6">
                                                        <input id="<?= $v_parent; ?>"
                                                                ...
                                                                ?>
                                                                   class="<?= $v_parent; ?> form-check-input" type="checkbox"
                                                                   name="view_<?= $v_parent; ?>"
                                                                   value="<?= $v_parent; ?>">
                                                        <label class="form-check-label view" data-bs-toggle="tooltip"
                                                               data-bs-placement="top"

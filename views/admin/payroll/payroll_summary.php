...
<div class="row">
    <div class="col-sm-12" data-spy="scroll" data-offset="0">
        <div class="card"><!-- *********     Employee Search Panel ***************** -->
            <div class="card-body">
                <h4 class="card-title mb-4"><?= lang('payroll_summary') ?></h4>
                ...
                <div class="row mb-3">
                    <label for="field-1" class="col-sm-3 col-form-label"><?= lang('search_type') ?> <span class="required"> *</span></label>

                    <div class="col-sm-5">
                        <select required name="search_type" id="search_type" class="form-select">
                ...
                <div class="by_employee" style="display: <?= !empty($search_type) && $search_type == 'employee' ? 'block' : 'none' ?>">
                    <?php super_admin_form($companies_id, 3, 5) ?>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label"><?= lang('employee') . ' ' . lang('name') ?>
                ...
                <div class="by_month" style="display: <?= !empty($search_type) && $search_type == 'month' ? 'block' : 'none' ?>">
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label"><?= lang('select') . ' ' . lang('month') ?> <span class="required"> *</span></label>
                        <div class="col-sm-5">
                            <div class="input-group">
                                <input type="text" value="<?php  if (!empty($by_month)) { echo $by_month; } ?>" class="form-control monthyear by_month" name="by_month" data-provide="datepicker" data-date-container="#payment_month" data-date-format="MM yyyy" data-date-min-view-mode="1" data-date-autoclose="true">
                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="by_period" style="display: <?= !empty($search_type) && $search_type == 'period' ? 'block' : 'none' ?>">
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label"><?= lang('start') . ' ' . lang('month') ?> <span class="required"> *</span></label>
                        <div class="col-sm-5">
                            <div class="input-group">
                                <input type="text" value="<?php if (!empty($start_month)) { echo $start_month; } ?>" class="by_period form-control monthyear" name="start_month" data-provide="datepicker" data-date-container="#payment_month" data-date-format="MM yyyy" data-date-min-view-mode="1" data-date-autoclose="true">
                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label"><?= lang('end') . ' ' . lang('month') ?> <span
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                ...
                                ?>" class="by_period form-control monthyear" name="end_month" data-provide="datepicker" data-date-container="#payment_month" data-date-format="MM yyyy" data-date-min-view-mode="1" data-date-autoclose="true">
                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                            </div>
                        </div>
                    </div>
...
?>
<div id="payment_history" class="row all_payment_history">
    ...
    <div class="card">
        <div class="card-body">
            <div class="pull-right"><!-- set pdf,Excel start action -->
                <label class="hidden-print col-form-label pull-left hidden-xs">
                    <button class="btn btn-danger btn-xs" data-bs-toggle="tooltip" data-placement="top"
            ...
            <h4 class="card-title mb-4"><?= lang('payroll_summary') . ' ' . $by ?></h4>
               
            <!-- Table -->
            <table class="table table-striped dt-responsive nowrap w-100" id="payroll_smry" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th><?= lang('month') ?></th>
                        <th><?= lang('date') ?></th>
                        ...
                        foreach ($employee_payroll as $index => $v_payroll) {
                            ...
                            <tr>
                                ...
                                <td class="hidden-print">
                                    <a href="<?php echo base_url() ?>admin/payroll/salary_payment_details/<?php echo $v_payroll->salary_payment_id ?>" class="btn btn-info btn-sm" title="View" data-bs-toggle="modal"  data-bs-target="#myModal_lg"><span class="fa fa-list-alt"></span></a></td>
                            </tr>
                        <?php }; ?>
                    <?php } ?>
                </tbody>
...
<div class="by_activities row" style="display: <?= !empty($search_type) && $search_type == 'activities' ? 'block' : 'none' ?>">
    <div class="col-sm-12" data-spy="scroll" data-offset="0">
        <div class="card">
            <div class="card-body">
                <div class="pull-right float-end">
                    <a onclick="return confirm('<?= lang('delete_alert') ?>')"
                       ...
                       class="btn btn-sm btn-primary pull-right"><?= lang('clear') ?></a>
                </div>
                <h4 class="card-title mb-4"><?= lang('payroll_summary'); ?></h4>
            
                <table class="table table-striped dt-responsive nowrap w-100" id="payroll_activities">
                    <thead>
                        <tr>

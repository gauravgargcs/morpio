            ...
            <tr>
                ...
                <td>
                    <table style="width: 500px; margin-left: 10px; margin-bottom: 10px; font-size: 13px;">
                        <tr>
                            <td style="width: 30%;"><h2><?php echo "$emp_salary_info->fullname"; ?></h2></td>
                        </tr>
                        <?php super_admin_pdf($emp_salary_info->companies_id,true) ?>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 70%"><?= display_datetime($emp_salary_info->joining_date) ?></td>
                        </tr>
                    </table>
                </td>
            </tr>

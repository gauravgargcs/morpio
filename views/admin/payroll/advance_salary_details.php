<div class="panel panel-custom">
    ...
    <div class="panel-body form-horizontal">
        <?php super_admin_details_p($advance_salary_info->companies_id) ?>
        <div class="">
        ...
        <div class="">
            ...
            <div class="col-sm-8">
                <p class="form-control-static"><span
                        class="text-danger"><?= display_datetime($advance_salary_info->request_date) ?></span>
                </p>
            </div>
        </div>
        ...
        <div class="">
            ...
            <div class="col-sm-8">
                <blockquote
                    style="font-size: 12px; margin-top: 5px"><?= strip_html_tags($advance_salary_info->reason) ?></blockquote>
            </div>
        </div>
        <?php if (!empty($advance_salary_info->comments)) { ?>
            <div class="">
                ...
                <div class="col-sm-8">
                    <blockquote
                        style="font-size: 12px; margin-top: 5px"><?= strip_html_tags($advance_salary_info->comments) ?></blockquote>
                </div>
            </div>
        <?php } ?>

                    ...
                    <div class="mailbox-read-info">
                        ...
                        <?php if (!empty($reply)) { ?>
                            <div class="pull-right">
                                <a href="<?= base_url() ?>admin/mailbox/index/compose/<?= $read_mail->inbox_id ?>/reply" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" title="" data-original-title="Reply"><i class="fa fa-reply"></i></a>                                
                                <a href="<?= base_url() ?>admin/mailbox/delete_inbox_mail/<?= $read_mail->inbox_id ?>" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" title="" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>
                            </div>      

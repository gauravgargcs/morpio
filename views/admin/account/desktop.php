...
<body>
<form method="post" name="customerData" action="<?= base_url('admin/account/new_test') ?>">
    ...
    <table width="40%" height="100" border='1' align="center">
        ...
        <tr>
            <td>Merchant Id :</td>
            <td><input type="text" name="merchant_id" value=""/></td>
        </tr>
        <tr>
            <td>Order Id :</td>
        ...
        <tr>
            ...
            <td><input type="text" name="redirect_url"
                       value="http://localhost/Non_Seamless_kit/ccavResponseHandler.php"/></td>
        </tr>
        <tr>
            <td>Cancel URL :</td>
            <td><input type="text" name="cancel_url" value="http://localhost/Non_Seamless_kit/ccavResponseHandler.php"/>
            </td>
        </tr>
        <tr>
            <td>Language :</td>

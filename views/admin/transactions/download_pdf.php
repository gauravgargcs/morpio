...
<br/>
<?php
$account_info = get_row('tbl_accounts', array('account_id' => $expense_info->account_id));
    ...
    <div>
        ...
        <table style="width: 100%; font-size: 13px;margin-top: 20px">
            ...
            if ($expense_info->invoices_id != 0) {
                ...
                ?>
                <?php if (!empty(super_admin_opt_td($expense_info->companies_id))) { ?>
                    <tr>
                        <td style="width: 30%;text-align: right"><strong><?= lang('companies') ?> :</strong>
                        </td>
                        <?php super_admin_opt_td($expense_info->companies_id) ?>
                    </tr>
                <?php } ?>
                <tr>
            ...
            <tr>
                ...
                <td style="">&nbsp; <?php
                    echo display_datetime($expense_info->date);
                    ?></td>
            </tr>
            <tr>

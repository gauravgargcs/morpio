...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4"><?= '[' . $category . '] ' . $expense_info->name . ' - ' . lang('preview_invoice') ?></h4>
                <?php
                                ...
                                <div class="col-lg-7">
                                    <div class="input-group">
                                        ...
                                        if (!empty($invoice_info->due_date)) {
                                            echo display_datetime($invoice_info->due_date);
                                        } else {
                                            echo date('d-m-Y H-i');
                                        }
                                        ?>" data-date-format="<?= config_item('date_picker_format'); ?>">
                                                ...
                                                <label class="needsclick">
                                                    <input type="checkbox"
                                                        ...
                                                        ?>
                                                           ...
                                                           name="assigned_to[]" data-name="<?= $v_user->username;?>" 
                                                           class="needsclick">
                                                                <span

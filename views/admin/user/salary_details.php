...
<div class="card-body">
    ...
    <?php } ?>
    <h4 class="card-title mb-4"><?= lang('salary_details') ?></h4>   
    <div class="row mb-3">
    <?php if (!empty($emp_salary_info)) { ?>
        <div class="col-sm-6">
            <div class="row mb-3">
                <label class="col-sm-5 form-label"><strong><?= lang('salary_grade') ?>:</strong></label>
                <p class="form-control-static"><?php echo $emp_salary_info->salary_grade; ?></p>
            </div>
            <div class="row mb-3">
                <label class="col-sm-5 form-label"><strong><?= lang('basic_salary') ?>:</strong></label>
            ...
            <div class="row mb-3">
                <label class="col-sm-5 form-label"><strong><?= lang('overtime') ?><small>(<?= lang('per_hour') ?>)</small>:</strong> </label>
                <p class="form-control-static">
                    <?php
        ...
        <div class="col-sm-6">
            <div class="row panel panel-custom" style="margin-left: -30px">
                ...
                <div class="panel-body">
                    ...
                    ?>
                        <div class="">
                            <label class="col-sm-6 form-label"><strong><?php echo $v_allowance_info->allowance_label; ?>: </strong></label>
                    ...
                    if (!empty($salary_deduction_info)):foreach ($salary_deduction_info as $v_deduction_info):
                        ...
                        <div class="">
                            ...
                            <label
                                ...
                                class="col-sm-6 form-label"><strong><?php echo $v_deduction_info->deduction_label; ?>
                ...
                <div class="panel-body">
                    ...
                    <div class="">
                        ...
                        <label
                            ...
                            class="col-sm-6 form-label"><strong><?= lang('gross_salary') ?>
                    ...
                    <div class="">
                        ...
                        <label
                            ...
                            class="col-sm-6 form-label"><strong><?= lang('total_deduction') ?>
                    ...
                    <div class="">
                        ...
                        <label class="col-sm-6 form-label"><strong><?= lang('net_salary') ?>
    ...
    <?php } else { ?>
        <div class="col-sm-6">
            <p class="form-control-static"><?php echo lang('no_data'); ?></p>
        </div>
    <?php } ?>
    </div>
</div>
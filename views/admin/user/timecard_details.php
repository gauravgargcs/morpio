<div class="card-body">
    ...
    <?php } ?>
    <h4 class="card-title mb-4"><?= lang('timecard_details') ?></h4>
    <div class="row">
        <form id="attendance-form" role="form" enctype="multipart/form-data"  action="<?php echo base_url(); ?>admin/user/user_details/<?= $profile_info->user_id ?>/6" method="post"  class="form-horizontal">
            <div class="row mb-3">
                <label class="col-sm-3 form-label"><?= lang('month') ?><span class="required"> *</span></label>
                <div class="col-sm-5">

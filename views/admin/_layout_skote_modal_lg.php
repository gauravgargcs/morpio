...
<!-- Modal -->
<div class="modal fade" id="myModal_lg" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script type="text/javascript">
     $('#myModal_lg').on('shown.bs.modal', function (e) {
    ...
    $('#myModal_lg').on('hidden.bs.modal', function () {

    ...
    <div class="col-md-3">
        <div class="card">
            ...
            <ul class="nav flex-column nav-pills">
                ...
                $can_do = can_do(111);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'general') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(112);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'system') || ($load_setting == 'all_currency') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(113);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'email_settings') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(114);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'templates') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(115);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'email_integration') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(116);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'payments') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(117);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'invoice') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(141);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'estimate') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(151);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'proposals') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(152);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'purchase') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(153);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'manufacturer') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(119);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'tickets') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(120);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'theme') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(145);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'dashboard') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(121);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'working_days') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(122);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'leave_category') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(123);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'income_category') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(124);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'expense_category') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(125);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'customer_group') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(127);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'lead_status') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(128);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'lead_source') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(129);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'opportunities_state_reason') ? 'active' : ''; ?>">
                ...
                <?php } ?>
                 <li class="nav-link mb-2 <?php echo ($load_setting == 'allowed_ip') ? 'active' : ''; ?>">
                ...
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'custom_field') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(131);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'payment_method') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(132);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'cronjob') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(133);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'menu_allocation') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(134);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'notification') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(135);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'email_notification') ? 'active' : ''; ?>">
                ...
                $can_do = can_do(136);
                if (!empty($can_do)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'database_backup') ? 'active' : ''; ?>">
                ...
                if (!empty($can_do && !$is_subdomain)) { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'translations') ? 'active' : ''; ?>">
                ...
                if (!empty($can_do) && $can_do == 'owner') { ?>
                    <li class="nav-link mb-2 <?php echo ($load_setting == 'system_update') ? 'active' : ''; ?>">

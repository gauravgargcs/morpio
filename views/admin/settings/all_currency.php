        ...
        <div class="panel-title">
            ...
            <div class="pull-right">
                <?php if ($this->session->userdata('user_type') == '1') { ?>
                    <span data-toggle="tooltip" data-placement="top" title="<?= lang('new_currency'); ?>"> </span>
                        <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/settings/new_currency" class="btn btn-sm btn-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <?= btn_delete('admin/settings/all_currency/' . $v_currencies->code . '/delete') ?>
                                    <?php }
                                    ?>
                                </td>
                            </tr>

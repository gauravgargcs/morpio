...
<div class="card">
    ...
    <div class="card-body">
        <h4 class="card-title mb-4"><?= lang('lead_status') ?></h4>
                            ...
                            <?php if (!empty($edited) || !empty($deleted)) { ?>
                                <td>
                                    ...
                                    <?php } else {
                                        ...
                                        <?php }
                                        if (!empty($deleted)) { ?>
                                            <?php echo ajax_anchor(base_url("admin/settings/delete_lead_status/" . $lead_status->lead_status_id), "<i class='btn btn-outline-danger btn-sm fa fa-trash-o' style='height:26px;'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-child-on-success" => ".child", "data-fade-out-on-success" => "#lead_status_" . $lead_status->lead_status_id)); ?>
                                        <?php }
                                    }
                                    ?>
                                </td>
                ...
                if (!empty($created) || !empty($edited)) { ?>
                    <form method="post" action="<?= base_url() ?>admin/settings/lead_status/update_lead_status"
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="submit" class="btn btn-sm btn-info custom-btn"><?= lang('add') ?></button>
                            </td>
                        </tr>
                    </form>
                <?php } ?>

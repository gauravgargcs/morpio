        ...
        if (!empty($super_admin) && !$sub_domain) { ?>
            <div class="col-sm-8 ">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="subscriptions_id" id="subscriptions_id" class="select_box form-control m0" data-width="100%"
            ...
            <div class="form-group">
                <label for="discount_type"
                       class="control-label col-sm-3"><?= lang('select') . ' ' . lang('package') ?><span
                        class="required">*</span></label>
                <div class="col-sm-9">
                    <select name="pricing_id" id="pricing_id" class="select_box form-control m0" data-width="100%"

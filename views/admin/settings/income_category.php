...
<div class="card">
    ...
    <div class="card-body">
        <h4 class="card-title mb-4"><?= lang('income_category') ?></h4>
                            ...
                            <?php if (!empty($edited) || !empty($deleted)) { ?>
                                <td>
                                    ...
                                    <?php } else {
                                        ...
                                        <?php }
                                        if (!empty($deleted)) { ?>
                                            <?php echo ajax_anchor(base_url("admin/settings/delete_income_category/" . $income_category->income_category_id), "<i class='btn btn-outline-danger btn-sm fa fa-trash-o' style='height:26px;'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-child-on-success" => ".child", "data-fade-out-on-success" => "#income_category_" . $income_category->income_category_id)); ?>
                                        <?php }
                                    }
                                    ?>
                                </td>

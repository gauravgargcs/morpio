<div id="printableArea">
    <form action="<?php echo base_url() ?>admin/performance/give_performance_appraisal/<?php
        ...
        <div class="modal-header">
            <h5 class="modal-title"><?= lang('performance_appraisal_details') ?></h5>
                ...
                <div class="col-lg-12" style="margin-top: 5px;">
                    <div class="row">
                        <div class="col-lg-2 col-sm-2">
                            <div class="fileinput-new thumbnail" style="width: 140px; height: 154px; margin-top: 14px; margin-left: 16px; background-color: #EBEBEB;">
                                <?php if ($get_appraisal_info->avatar): ?>
                                    <img src="<?php echo base_url() . $get_appraisal_info->avatar; ?>"
                                         style="width: 138px; height: 144px; border-radius: 3px;" class="img-thumbnail avatar-md">
                                <?php else: ?>
                                    <img src="<?php echo base_url() ?>/img/user.png" alt="Employee_Image" class="img-thumbnail avatar-md">
                                <?php endif; ?>
                            </div>
                        </div>

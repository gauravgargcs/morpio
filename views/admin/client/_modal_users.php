<form id="form_validation" action="<?php echo base_url() ?>admin/client/update_member/<?php if (!empty($client_info->client_id)) echo $client_info->client_id; ?>" method="post" class="form-horizontal">
    ...
    <div class="modal-body wrap-modal wrap">
        <div class="col-xl-12"> 
            <div class="row mb-3">      
                ...
                <div class="form-check form-check-primary mb-3 col-xl-3">
                    <input id="everyone" <?php if (!empty($client_info->permission) && $client_info->permission == 'all') {
                            echo 'checked';
                        } 
        ...
        <div class="row mb-3">
            <div class="col-xl-12"> 
                <div class="row <?php if (!empty($client_info->permission) && $client_info->permission != 'all') { echo 'show'; } ?>" id="permission_user">
                    ...
                    if (!empty($assign_user)) { ?>
                        ...
                        <div data-simplebar style="max-height: 250px;">  
                            ...
                            <div class="action p  <?php   if (!empty($client_info->permission) && $client_info->permission != 'all') { $get_permission = json_decode($client_info->permission);
                                if (is_object($get_permission)) {
                                    foreach ($get_permission as $user_id => $v_permission) {
                                        if ($user_id == $v_user->user_id) {
                                            echo 'show';

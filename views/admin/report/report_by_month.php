...
<div class="row">
    <div class="col-lg-4 col-sm-12 col-md-6">
        <form action="<?php echo base_url() ?>admin/report/report_by_month" method="post">
            <label for="field-1" class="card-title mb-4"><strong><?= lang('year') ?>:</strong></label>
            <div class="hstack gap-3">
                
           
                <input type="text" name="year" class="form-control me-auto years" value="<?php
                if (!empty($year)) {
                    echo $year;
                }
                ?>" data-format="yyyy">
            
            <button type="submit" id="search_product" data-bs-toggle="tooltip" data-bs-placement="top" title="Search"
            ...
            <ul class="nav flex-column nav-pills">
                ...
                foreach ($report_by_month as $key => $v_month):
                    ...
                    ?>">
                        ...
                        ?>" data-bs-toggle="tab" href="#<?php echo $month_name ?>">
                                    ...
                                    <div class="panel-title">
                                        ...
                                        <div class="pull-right hidden-print">
                                            ...
                                            <button class="btn btn-danger btn-xs"
                                                    type="button" data-bs-toggle="tooltip" title="Print"

...
<div style="background: #E0E5E8;padding: 5px;">
    ...
    <div style="font-size: 15px;padding: 5px 0px 0px 0px"><?= lang('transactions') . ' ' . lang('report_from') ?>
        :<strong>
        <?= display_datetime($start_date); ?></div>
    <div
            style="font-size: 15px;padding: 0px 0px 0px 0px">
        </strong><?= lang('transactions') . ' ' . lang('report_to') ?>
        : <strong><?= display_datetime($end_date); ?></strong>
    </div>
</div>
<br/>
<div style="width: 100%;">

...
<form role="form" enctype="multipart/form-data" id="form"
    ...
    <div class="row mt-2">
        <label class="col-lg-3 col-md-3 col-sm-3 col-form-label"><?= lang('account') ?> <span class="text-danger">*</span> </label>
    ...
    <div class="row mt-2">
        <label class="col-lg-3 col-md-3 col-sm-3 col-form-label"><?= lang('start_date') ?></label>
        <div class="col-lg-5 col-md-5 col-sm-5">
    ...
    <div class="row mt-2">
        <label class="col-lg-3 col-md-3 col-sm-3 col-form-label"><?= lang('end_date') ?></label>
        <div class="col-lg-5 col-md-5 col-sm-5">
            <div class="input-group">
    ...
    <div class="row mt-2">
        <label class="col-lg-3 col-md-3 col-sm-3 col-form-label"><?= lang('type') ?> <span class="text-danger">*</span> </label>
        <div class="col-lg-5 col-md-5 col-sm-5">
                    ...
                    if (!empty($all_transaction_info)):
                        ...
                        <div class="pull-right hidden-print">
                            <a href="<?php echo base_url() ?>admin/report/account_statement_pdf/<?= $account_id . '/' . date('Y-m-d', strtotime($start_date)) . '/' . date('Y-m-d', strtotime($end_date)) . '/' . $transaction_type ?>"
                               class="btn btn-xs btn-success" data-bs-toggle="tooltip" data-bs-placement="top"

                    ...
                    <tr>
                        ...
                        <td>
                            <a class="hidden-print"
                               href="<?= base_url() ?>admin/invoice/manage_invoice/payments_details/<?= $payments->payments_id ?>"> <?= display_datetime($payments->payment_date); ?></a>
                            <span
                                    class="show_print"><?= display_datetime($payments->payment_date) ?></span>
                        </td>

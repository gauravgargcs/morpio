...
<div class="row">
    <div class="card"> 
        <div class="card-body"><div class="panel panel-custom">
                    ...
                    ?>
                     <tr id="table_expense_<?=$v_expense->transactions_id;?>">
                        ...
                        <td><?= btn_edit('admin/transactions/expense/' . $v_expense->transactions_id) ?>
                                  ...
                                  <?php echo ajax_anchor(base_url("admin/transactions/delete_expense/$v_expense->transactions_id"), "<i class='btn btn-outline-danger btn-sm fa fa-trash-o' style='height:26px;'></i>", array("class" => "", "title" => lang('delete'), "data-fade-out-child-on-success" => ".child", "data-fade-out-on-success" => "#table_expense_" . $v_expense->transactions_id)); ?></td>
                    </tr>
                    <?php

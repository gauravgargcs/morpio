<form id="form_validation" action="<?php echo base_url() ?>admin/bugs/update_member/<?php if (!empty($bugs_info->bug_id)) echo $bugs_info->bug_id; ?>" method="post" class="form-horizontal">

...
<!-- Modal -->
<div class="modal fade" id="myModal_large" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    $('#myModal_large').on('shown.bs.modal', function (e) {
                            ...
                            success: function (response) {
                                if (response.success) {
                                    ...
                                    $(file.previewTemplate).append("<input type='hidden' name='file_name_" + fileSerial + "' value='" + file.name + "' />\n\
                                                            ...
                                                            <input type='hidden' name='file_" + fileSerial + "' value='" + file + "' />");

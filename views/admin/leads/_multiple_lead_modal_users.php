<form id="form_validation" action="<?php echo base_url() ?>admin/leads/mutiple_lead_update_member" method="post" class="form-horizontal form-groups-bordered">
...
<script type="text/javascript">
    ...
    function submitMultipleUserUpdate (){
        ...
        $(".action-check:checked").each(function(){
            $('#form_validation').append("<input type='hidden' name='leads_id[]' value='"+$(this).val()+"'>");
        });

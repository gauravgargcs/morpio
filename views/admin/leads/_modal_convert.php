<div class="card-body">
<form data-parsley-validate="" novalidate="" action="<?php echo base_url() ?>admin/leads/converted/<?php if (!empty($leads_info->leads_id)) echo $leads_info->leads_id; ?>" method="post" class="form-horizontal">
<form role="form" enctype="multipart/form-data" id="form" action="<?php echo base_url(); ?>admin/client/save_client/<?php if (!empty($client_info)) { echo $client_info->client_id;  } ?>" method="post" class="form-horizontal  ">
    <div class="modal-header">
        <h5 class="modal-title"><?= lang('convert_to_client') ?></h5>
            ...
            <div class="col-xl-12"> 
                ...
                <ul class="nav nav-tabs bg-light rounded" role="tablist">
                    <li class="nav-item waves-light">
                        <a class="nav-link active" href="#general_compnay" data-bs-toggle="tab"><?= lang('general') ?></a>
                    </li>
                    <li class="nav-item waves-light">
                        <a class="nav-link" href="#contact_compnay" data-bs-toggle="tab"><?= lang('client_contact') . ' ' . lang('details') ?></a>
                    </li>
                    <li class="nav-item waves-light">
                        <a class="nav-link" href="#web_compnay" data-bs-toggle="tab"><?= lang('web') ?></a>
                    </li>
                    <li class="nav-item waves-light">
                        <a class="nav-link" href="#hosting_compnay" data-bs-toggle="tab"><?= lang('hosting') ?></a>
                    </li>
                </ul>
                <div class="tab-content p-3 text-muted">
                    <div class="chart tab-pane active" id="general_compnay">
                        <div class="row mb-3">
                            <label class="col-xl-3 col-form-label"><?= lang('company_name') ?></label>
                            <div class="col-xl-9">
                        ...
                        <div class="row mb-3">
                            <label class="col-xl-3 col-form-label"><?= lang('company_email') ?>
                            </label>
                            <div class="col-xl-9">
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('company_vat') ?></label>
                            <div class="col-xl-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-9">
                                <select name="customer_group_id" class="form-control modal_select_box"
                                        style="width: 100%">
                                    <?php
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-9">
                                <select name="language" class="form-control company modal_select_box"
                                        style="width: 100%">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-9">
                                <select name="currency" class="form-control company modal_select_box"
                                        style="width: 100%">
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('short_note') ?></label>
                            <div class="col-xl-9">
                    ...
                    <div class="chart tab-pane" id="contact_compnay">
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('company_phone') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label class="col-xl-3 col-form-label"><?= lang('company_mobile') ?>
                                <span
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('company_fax') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('company_city') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('company_country') ?></label>
                            <div class="col-xl-9">
                                <select name="country" class="form-control company modal_select_box"
                                        style="width: 100%">
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('company_address') ?></label>
                            <div class="col-xl-9">
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('longitude') . '( ' . lang('google_map') . ' )' ?></label>
                            <div class="col-lg-5">
                    ...
                    <div class="chart tab-pane" id="web_compnay">
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('company_domain') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('skype_id') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('facebook_profile_link') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('twitter_profile_link') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('linkedin_profile_link') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                    ...
                    <div class="chart tab-pane" id="hosting_compnay">
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('hosting_company') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('hostname') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('username') ?> </label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php
                        ...
                        <div class="row mb-3">
                            <label
                                class="col-xl-3 col-form-label"><?= lang('password') ?></label>
                            <div class="col-xl-9">
                        ...
                        <div class="row mb-3">
                            <label class="col-xl-3 col-form-label"><?= lang('port') ?></label>
                            <div class="col-xl-9">
                                <input type="text" class="form-control company" value="<?php

...
<div class="d-flex py-3 border-top" id="<?php echo $comment_type . "-comment-form-container-" . $v_comment->task_comment_id ?>">
    ...
    <div class="flex-grow-1">
        ...
        <div>
            ...
            ?>
            <button class="text-primary reply" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= lang('click_to_reply') ?>" id="reply__<?php echo $v_comment->task_comment_id ?>"><i class="fa fa-reply "></i> <?= lang('reply') ?></button>
        </div>   
        ...
        <div class="reply__" id="reply_<?php echo $v_comment->task_comment_id ?>">
            <form id="<?php echo $comment_reply_type; ?>-comment-form-<?php echo $v_comment->task_comment_id ?>"  action="<?php echo base_url() ?>admin/opportunities/save_comments_reply/<?php
                ...
                <button type="submit" id="reply-<?php echo $v_comment->task_comment_id ?>" class="btn btn-xs btn-primary"><?= lang('save') ?></button>
            </form>
        </div>

...
<form role="form" id="from_items" data-parsley-validate="" novalidate="" action="<?php echo base_url(); ?>admin/estimates/converted/<?= $estimates_info->estimates_id ?>" method="post" class="form-horizontal">
                ...
                <div class="col-xl-6 br pv">
                        ...
                        <div class="f_client_id">
                            <div class="row mb-3">
                                ...
                                <div class="col-xl-7 col-md-7 col-sm-7">
                                    <select class="form-control modal_select_box  ajax-search" required
                                            style="width: 100%"
                                            name="client_id"
                                ...
                                <div class="input-group">
                                    <input type="text" name="invoice_date"
                                           ...
                                           if (!empty($estimates_info->estimate_date)) {
                                               echo date('d-m-Y H:i', strtotime($estimates_info->estimate_date));
                                           } else {
                                               echo date('d-m-Y H-i');
                                           }
                                           ?>"
                                ...
                                <div class="input-group">
                                    <input type="text" name="due_date"
                                           ...
                                           if (!empty($estimates_info->due_date)) {
                                               echo date('d-m-Y H:i', strtotime($estimates_info->due_date));
                                           } else {
                                               echo date('d-m-Y H-i');
                                           }
                                           ?>"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-xl-7 col-md-7 col-sm-7">
                                <select name="discount_type" class="form_control modal_select_box" data-width="100%">
                                    <option value=""
                    ...
                    <div class="col-xl-8" style="display:inline-flex;">
                        ...
                        <div class="form-check form-radio-outline form-radio-primary mt mr">
                            <input type="radio" value="hours" id="<?php echo lang('hours'); ?>"
                                   name="show_quantity_as"  <?php if (isset($estimates_info) && $estimates_info->show_quantity_as == 'hours' || isset($hours_quantity)) {  echo 'checked'; } ?> class="form-check-input">

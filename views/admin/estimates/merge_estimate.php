    ...
    <div class="card-body">
        ...
        <div class="pl-lg">
            ...
            <div class="form-check form-check-primary mb-3 mt-sm">
                ...
                <input type="checkbox" name="invoices_to_merge[]" value="<?php echo $_inv->estimates_id; ?>" class="form-check-input">
                <label class="form-check-label">
                    <a href="<?php echo base_url() . 'admin/estimates/index/estimates_details/' . $_inv->estimates_id; ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-title="<?php echo lang($_inv->status); ?>" target="_blank"><?php echo $_inv->reference_no; ?></a>
                            -<?= display_money($this->estimates_model->estimate_calculation('total', $_inv->estimates_id), $currency->symbol); ?>
                </label>
            </div>
            <?php } ?>
            <div class="form-check form-check-primary mb-3 mt-sm">
                <input type="checkbox" checked name="cancel_merged_estimate" id="cancel_merged_invoices" class="form-check-input">
                <label class="form-check-label"><strong><?php echo lang('cancel_merged_estimate'); ?></strong></label>
            </div>
        </div>
    </div>
</div>

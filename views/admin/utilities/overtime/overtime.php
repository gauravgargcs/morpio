...
<div class="row">
    <div class="col-lg-3 col-md-4 col-sm-6">
        ...
        <button type="submit" data-bs-toggle="tooltip" data-bs-placement="top" title="Search"
                class="btn btn-purple pull-right mlt-15-10">
            <i class="fa fa-search"></i></button>
        <?php echo form_close(); ?>
    </div>

    <div class="col-lg-9 col-md-8 col-sm-6 mt">
        <a href="<?= base_url() ?>admin/utilities/add_overtime" class="text-danger" data-bs-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td><?= $status ?>
                                        ...
                                        if ($this->session->userdata('user_type') == 1) {
                                            if ($v_overtime->status == 'pending') { ?>
                                                <a data-bs-toggle="tooltip" data-placment="top"
                                                   title="<?= lang('approved') ?>"

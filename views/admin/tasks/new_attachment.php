<form action="<?= base_url() ?>admin/tasks/save_attachment" id="attachment-form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" accept-charset="utf-8" novalidate="novalidate">
    ...
    <div class="modal-body wrap-modal wrap">
        <div class="mb-3 row">
            <label class="col-lg-3 form-label"><?= lang('file_title') ?> <span
    ...
    <div class="modal-footer">
        <div class="mb-3">
            ...
            <button id="file-task_btn" type="submit" disabled="disabled" class="btn btn-primary start-upload"><span class="fa fa-check-circle"></span> <?php echo lang('save'); ?></button>            
        </div>
    </div>
</form>
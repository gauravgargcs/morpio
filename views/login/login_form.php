...
<form data-parsley-validate="" novalidate="" action="<?php echo base_url() ?>login" method="post">
    <div class="form-group has-feedback"  data-toggle="tooltip" data-html="true" data-placement="bottom" title='Having a login issues? <br> <br> Your unique login is<br> "yourdomain.allbizhub.com" '>
...
if ( $sub_domain=='' ||  $sub_domain=='www') { ?>
    <p class="pt-lg text-center"><?= lang('do_not_have_an_account') ?></p><a href="<?= base_url() ?>#pricing"
                                                                             class="btn btn-block btn-default"><i
            class="fa fa-sign-in"></i> <?= lang('Start your free trial demo today') ?>.</a>
<?php } ?>

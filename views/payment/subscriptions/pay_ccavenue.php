...
$merchant_data = '';
$working_key = getConfigItems('ccavenue_key');//Shared by CCAVENUES
$access_code = getConfigItems('ccavenue_access_code');//Shared by CCAVENUES

foreach ($_POST as $key => $value) {
    $merchant_data .= $key . '=' . $value . '&';
}
$encrypted_data = encrypt_cc($merchant_data, $working_key); // Method for encrypting the data.
if (getConfigItems('ccavenue_enable_test_mode') == 'TRUE') {

...
<?php foreach ($all_chats as $v_chat) : ?>
    ...
    <?php elseif ($v_chat->active == 1) : ?>
        ...
        ?>
        <div class="card b0 mb0 chat_<?= $v_chat->to_user_id ?>" id="open_chat_box_<?php echo $v_chat->private_chat_id ?>">
            <div class="card-body custom-bg pt-sm ">
                ...
                <h5 class="chat_title card-title mb-3"> <?php echo $v_chat->title ?></h5>
            
                <div class="chat-body br bl" id="open_chat_<?php echo $v_chat->private_chat_id ?>" data-simplebar style="max-height: 250px;">
                    <ul>
            ...
            <div class="card-footer b0 chat-input-box">

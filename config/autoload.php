...
$autoload['libraries'] = array('database', 'session', 'menu', 'breadcrumbs', 'encryption', 'form_validation', 'gateways/app_gateway','module');
$CI = &get_instance();
...
$autoload['helper'] = array('url', 'html', 'admin_helper', 'alert_helper', 'file', 'language', 'oneall', 'files_helper');

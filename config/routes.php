...
$route['check-login-link'] = 'frontend/check_login_link'; // added by AG cloud1
//$route['links-found'] = 'frontend/links_found'; // added by AG cloud1
$route['check-again'] = 'frontend/check_again'; // added by AG cloud1

...
// $config['default_database'] = 'allbizsaleshub_saas2';
// $config['database_hostname'] = 'localhost';
// $config['database_username'] = 'allbizsaleshub_saas2';
// $config['database_password'] = 'i5x.0O,8(]dR';
// $config['default_url'] = 'https://allbizsales.net.au/';

$config['default_database'] = 'merpi1_main_saas';
$config['database_hostname'] = 'localhost';
$config['database_username'] = 'merpi1_crm_user';
$config['database_password'] = 'mv)~MhC$BDgm';
$config['default_url'] = 'https://allbizsales.net.au/';

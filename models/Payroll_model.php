...
class Payroll_Model extends MY_Model
{
    ...
    public function get_emp_salary_list($id = NULL, $designation_id = NULL)
    {
        ...
        $this->db->select('tbl_account_details.*', FALSE);
        $this->db->select('tbl_salary_template.salary_grade,tbl_salary_template.basic_salary,tbl_salary_template.overtime_salary', FALSE);
        $this->db->select('tbl_hourly_rate.hourly_grade,tbl_hourly_rate.hourly_rate', FALSE);
        $this->db->select('tbl_designations.*', FALSE);
        $this->db->select('tbl_departments.deptname', FALSE);

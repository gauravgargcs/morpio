...
class projects extends Admin_Controller
{
    ...
    public function projects_kanban($id = NULL)
    {
        $edited = can_action('57', 'edited');
        ...
        $data['all_project_info'] = $this->items_model->get_all_project($this->uri->segment(4));
        $data['subview'] = $this->load->view('admin/projects/all_project_kanban', $data, TRUE);
        $this->load->view('admin/_layout_skote_main', $data); //page load
    }
    ...
    public function new_project($id=NULL)
    {
        ...
        $data['all_project_info'] = $this->items_model->get_all_project($this->uri->segment(4));
        $data['subview'] = $this->load->view('admin/projects/new_projects', $data, TRUE);
        $this->load->view('admin/_layout_skote_main', $data); //page load
    }
    ...
    public function preview_invoice($id)
    {
        ...
        // get permission user by menu id
        $data['permission_user'] = $this->items_model->allowad_user('57');

...
class Stock extends Admin_Controller
{
    ...
    public function save_stock($id = NULL)
    {
        ...
        if (!empty($created) || !empty($edited)) {
            ...
            $data = $this->stock_model->array_from_post(array('stock_sub_category_id', 'item_name','code','price')); //input post
            ...
            if(!empty($item_data['purchase_date'])){
                $item_data['purchase_date']=date('Y-m-d H:i', strtotime($item_data['purchase_date']));
            }
    ...
    function set_assign_stock($id = NULL)
    {
        ...
        if (!empty($created) || !empty($edited)) {
            ...
            if(!empty($data['assign_date'])){
                $data['assign_date']=date('Y-m-d H:i', strtotime($data['assign_date']));
            }
    ...
    function report()
    {
        ...
        if (!empty($flag)) {
            ...
            if(!empty($date['start_date'])){
                $date['start_date']=date('Y-m-d H:i', strtotime($date['start_date']));
            }
